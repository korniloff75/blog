...
'<div class="b">'+
'<button type="button" onclick="document.getElementById(\'inputimg\').value = \'/<?=$modDir?>/img/default.jpg\';closewindow(\'window\');">Вствить фото по умолчанию</button> '+
	...
	if($act=='index')
	{
       ...
       <input type="submit" name="" value="Начать инициализацию">
		...
		<tr>
			...
			<td>
				<input type="text" name="img" id="inputimg" value="/'.$modDir.'/img/default.jpg">
				<button type="button" onclick="openwindow(\'window\', 750, \'auto\', iframefiles);">Выбрать файл</button>
			</td>
		</tr>
		<tr>
			<td></td>
			<td><img src="/'.$modDir.'/img/default.jpg" alt="" id="img" style="width: 380px;"></td>
		</tr>
		<tr>
				...
				while($i < $var){
					if($i < $nom){
						...
						echo'<div class="box">
							...
							echo'<h3 class="av"><img src="/'.$modDir.'/user.png" width="30" height="30" alt=""> <span>'.$lastComments[$i]['login'].'</span></h3>';
							}
...
if($act=='addin'){
		...
		$file1 = file_get_contents('../'.$modDir.'/file/uninstall.php');
        file_put_contents('uninstall.php', $file1);
		$file2 = file_get_contents('../'.$modDir.'/file/blogConfig.dat');
...
echo'
		...
		<div class="content">
		<div class="msg">
		<img src="../'.$modDir.'/file/busy.gif" alt=""><br><br>
